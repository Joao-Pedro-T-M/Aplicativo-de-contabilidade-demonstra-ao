...
class InventoryControlSheetCard extends StatefulWidget {
  ...
  const InventoryControlSheetCard({
    ...
    this.onInteractionChanged, required bool expanded, required void Function() onToggleExpanded,
  });
...
class _InventoryControlSheetCardState extends State<InventoryControlSheetCard> {
  void _openSheetFullscreen() {
    showGeneralDialog(
      context: context,
      barrierDismissible: true,
      barrierLabel: 'Ficha de Controle de Estoque',
      barrierColor: Colors.black54,
      transitionDuration: const Duration(milliseconds: 220),
      pageBuilder: (dialogContext, animation, secondaryAnimation) {
        return InventoryControlSheetFullscreen(
        ...
        child: Padding(
          ...
          child: Row(
            ...
            children: [
              ...
              IconButton(
                tooltip: 'Expandir',
                onPressed: _openSheetFullscreen,
...
class InventoryControlSheetFullscreen extends StatefulWidget {
  final String method;
  final List<_LedgerRowModel> rows;
  final Widget Function(List<_LedgerRowModel> rows) tableBuilder;
  final ValueChanged<bool>? onInteractionChanged;

  const InventoryControlSheetFullscreen({
    super.key,
    required this.method,
    required this.rows,
    required this.tableBuilder,
  ...
  @override
  State<InventoryControlSheetFullscreen> createState() =>
      _InventoryControlSheetFullscreenState();
}

class _InventoryControlSheetFullscreenState
    extends State<InventoryControlSheetFullscreen> {
  ...
  @override
  Widget build(BuildContext context) {
    final minWidth = widget.compactWidth(context);
...
extension on InventoryControlSheetFullscreen {
  double compactWidth(BuildContext context) {
    return MediaQuery.of(context).size.width < 700 ? 920.0 : 1060.0;
  }
}
